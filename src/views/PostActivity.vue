...
async function fetchPostStats() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + `/api/user/get_user_post_stats.php`, {
...
async function fetchMyPosts() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + '/api/user/get_user_posts.php', {
      params: { user_id: userId }
    });
    if (response.data.status === 'success') {
...
async function fetchMyReplies() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + '/api/user/get_user_post_comments.php', {
      params: { user_id: userId }
    });
    if (response.data.status === 'success') {
...
async function fetchMyCollectedPosts() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + '/api/user/get_user_favorites_posts.php', {
      params: { user_id: userId }
    });
    if (response.data.status === 'success') {
...
async function fetchMyReports() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + '/api/user/get_user_reports.php', {
      params: { user_id: userId }
    });
    if (response.data.status === 'success') {
...
async function fetchReportedRecords() {
  ...
  try {
    const response = await axios.get(import.meta.env.VITE_API_BASE + '/api/user/get_repimport.meta.env.VITE_API_BASE + `/api/user/orts_on_user.php', {
      params: { user_id: userId }
    });
    if (response.data.status === 'success') {
